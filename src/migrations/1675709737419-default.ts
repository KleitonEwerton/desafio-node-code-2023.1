...
export class default1675709737419 implements MigrationInterface {
    name = 'default1675709737419'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" SERIAL NOT NULL, "total_value" integer NOT NULL, "client_name" character varying NOT NULL, "client_city" character varying NOT NULL, "client_address" character varying NOT NULL, "client_phone" character varying NOT NULL, "restaurantId" integer, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "quantity" integer NOT NULL, "price" integer NOT NULL, "category" character varying NOT NULL, "restaurantId" integer, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
